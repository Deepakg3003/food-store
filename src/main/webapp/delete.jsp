...
String Dquery = "Delete from foodproduct Where pid=?";
Connection con=null;
try {
	Class.forName(fqcn);
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" action="singledescfetch.jsp">
        <input class="form-control me-2" name="desc" type="search" placeholder="Filter By Description" aria-label="Search">
...
<table class="table">
  ...
  <tbody class="table-light">
  	...
  	<%
  	/**
     * Retrieves and prints all food products from the database.
     */
