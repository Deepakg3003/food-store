...
<div class="container my-2 col-md-5">
  ...
  <input type="text" class="form-control" id="id" placeholder="Enter Product Id" name="pid">
</div>

<div class="mb-3">
		
  <label for="sku" class="form-label">Product SKU</label>
  <input type="text" class="form-control" id="sku" placeholder="Enter Product SKU" name="psku">
</div>
<div class="mb-3">
  <label for="Pdescribed" class="form-label">Description</label>
  <textarea class="form-control" id="pdescribed" rows="1" placeholder="Enter description" name="pdes"></textarea>
</div>
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" id="pcat" placeholder="Enter category" name="pcate">
</div>

<div class="mb-3">
		
  <label for="cost" class="form-label">Price</label>
  <input type="text" class="form-control" id="cost" placeholder="Enter Price" name="price">
</div>
