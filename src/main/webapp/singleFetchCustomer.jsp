...
<nav class="navbar navbar-expand-lg navbar-dark head">
  ...
  <div class="container-fluid">
	...
	String id =request.getParameter("fid");
		...
		String fqrl = "select * from customerdetails where customerID='"+cid+"'";
...
<div class="container my-2 col-md-4 my-5">
	<div class="card line">
		<div class="card-body">
			<div class="mb-3 ">
 			...
 			<div class="mb-3 my-5">
 		<h3>Customer ID: <%=sid %></h3>
		<h3>Business Name: <%=cName %></h3>
		<h3>Address: <%=cAddress %></h3>
		<h3>Telephone Number: <%=cNo %></h3>
			</div>
		</div>
	</div>
</div>
	...
	<% 
				...
				response.sendRedirect("notFoundCustomer.jsp");
