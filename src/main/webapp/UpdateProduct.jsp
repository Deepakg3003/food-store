...
<div class="container my-2 col-md-5">
  ...
  <input type="hidden" class="form-control" id="id" placeholder="Enter Product Id" name="pid" value="<%= iid %>" required="required">
</div>
<h3 class="text-center col-md-5 offset-md-3" style="color:green;">Update Product</h3>
<div class="mb-3">
